  ...
  return (
    <footer className="relative overflow-hidden bg-neutral-950 border-t border-white/5">
      ...
      <button
        ...
        className="absolute right-8 bottom-8 rounded-full bg-red-600 p-3 text-white shadow-lg shadow-red-600/30 transition-all duration-300 hover:scale-110 hover:shadow-red-600/50"
